...
class ControlTowerTest(unittest.TestCase):
    ...
    def test_predict_threat_should_return_threat_position_range(self):
        ...
        control_tower.tower_list["wt1"] = tower_info_1
        control_tower.tower_list["wt2"] = tower_info_2
        control_tower.last_noise_intensities = [0.010541213, 0.010367212, 0.010551292, 0.010367212, 0.010551292, 0.010547385, 0.010795445, 0.010547385, 0.010795445, 0.010522221]
        control_tower.check_for_threats()
        self.assertEqual(2, len(control_tower.tower_list))
        self.assertEqual(control_tower.threat['lat'], 40.41273649246327)
        self.assertEqual(control_tower.threat['lon'], -86.95072140569229)
        self.assertEqual(control_tower.threat['range'], 25)

    def test_get_top_two_towers_should_return_top_two(self):
        control_tower = ControlTower()
        control_tower.tower_list["ignored1"] = tower_info_3
        control_tower.tower_list["ignored2"] = tower_info_4
        control_tower.tower_list["wt1"] = tower_info_1
        control_tower.tower_list["wt2"] = tower_info_2
    ...
    def test_get_top_two_towers_with_false_detection_should_return_top_two(self):
        ...
        control_tower.tower_list["wt1"] = tower_info_1
        control_tower.tower_list["wt2"] = tower_info_2
        control_tower.tower_list["wt3"] = tower_info_3
        control_tower.tower_list["wt4"] = tower_info_4
        control_tower.tower_list["wt1"]["isThreatDetected"] = False
        first_id, second_id = control_tower.get_top_two_towers()
